 ...
 */
public class SiteAndInstallationAction extends AbstractAction<List<SiteAndInstallation>> {
     ...
     */
    public SiteAndInstallationAction(HttpClient httpClient) {
        this.httpClient = httpClient;
    }

    @SuppressWarnings("unchecked")
    @Override
    public List<SiteAndInstallation> perform(AwsProxyRequest request) {
        ...
        return mainConfigHolder.getSiteAndInstallations();

    }

    @Override
    public List<SiteAndInstallation> perform(String body, Map<String, String> query) {
        throw new UnsupportedOperationException("Unimplemented method 'perform'");
    }

    @Override
    public List<SiteAndInstallation> perform(AwsProxyRequest request, String s) {
        throw new UnsupportedOperationException("Unimplemented method 'perform'");
    }
}
