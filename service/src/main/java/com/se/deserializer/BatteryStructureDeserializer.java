...
public class BatteryStructureDeserializer extends AbstractConfigParamTableDeserializer<BatteryStructureHolder> {

    private static final String TABLE_NAME_PATTERN = "BatteryStructure";
    ...
    @Override
    public BatteryStructureHolder deserializeFromParams(List<Map<String, String>> params) {
        BatteryStructureHolder holder = new BatteryStructureHolder();
