...
public class InverterStructureDeserializer extends AbstractConfigParamTableDeserializer<InverterStructureHolder> {

    private static final String TABLE_NAME_PATTERN = "InverterStructure";
    ...
    @Override
    public InverterStructureHolder deserializeFromParams(List<Map<String, String>> params) {
        InverterStructureHolder holder = new InverterStructureHolder();
