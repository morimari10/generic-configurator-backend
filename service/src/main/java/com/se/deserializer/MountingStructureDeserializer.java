...
public class MountingStructureDeserializer extends AbstractConfigParamTableDeserializer<MountingStructureHolder> {

    private static final String TABLE_NAME_PATTERN = "MountingStructure";
    ...
    @Override
    public MountingStructureHolder deserializeFromParams(List<Map<String, String>> params) {
        MountingStructureHolder holder = new MountingStructureHolder();
